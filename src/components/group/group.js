    ...
    <div className="contentGroup">
      ...
      <div className="gridLayout">
        <div className="groupLabel">
          ...
          <FontAwesomeIcon icon="fire" style={{ color: "#C64750" }} size="4x" />
